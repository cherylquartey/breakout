...
25 PRINT "STANDARD COLORS";A$;: INPUT " Y/N", B$" IF B$(1,1)#N THEN GR: CALL -936: IF B$(1,1)#"N" THEN 40 : FOR I = 0 TO 39: COLOR=I/2*(I(32)): VLIN 0,39 AT I
...
35 GOSUB 95:A=E: PRINT "EVEN BRICK";: GOSUB 95:B=E: PRINT "ODD BRICK";: GOSUB 95:C=E: PRINT "BALL";: GOSUB 95
40 POKE 34,20: COLOR=A: FOR I=0 TO 39: VLIN 0,39 AT I: NEXT I: FOR I=20 TO 34 STEP 2: TAB I+1: PRINT I/2-9;: COLOR=B: VLIN 0,39 AT I: COLOR=C: FOR I = I MOD 4 TO 39 STEP 4
...
105 Q= PEEK (-16366)- PEEK (-16336)+ PEEK (-16366)- PEEK (-16336)+ PEEK (-16336)- PEEK (-16336)+ PEEK (-16336)- PEEK (-16336)+ PEEK (-16336)- PEEK (-16336)
110 IF S<720 THEN 80
115 PRINT "CONGRATULATION,";A$; "YOU WIN!": GOTO 165
...
160 PRINT "NEARLY PERFECT.": GOTO 165
