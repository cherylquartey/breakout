...
235 IF MID$ (A$,A,1) = " " THEN X = A + 1:A = 0: GOTO 260: REM THIS LOOKS FOR THE BLANK SEPERATING THE WORDS
240 V$ = V$ + MID$ (A$,A,1)
245 NEXT A
...
600 PRINT : GOTO 100
800 REM AND HERE'S TRHE WINNING OUTCOME OF THE GAME
...
825 PRINT "UNFORTUNATLEY, THE PRINCESS HAS JUST"
...
960 DATA "GOAT", "FLOWER", "GASOLINE", "BOTTLE", "PRINCESS" 
