...
15 REM CO = CONSITUTION
20 REM OC = OGRE'S CONTITUTION
25 REM ST = STRENGTH
...
235 PRINT "I'LL BET YOU COULD FIGHT FOR YOUR WEIGHT"
240 PRINT "IN "; CO; " WILDCATS."
245 PRINT : GOSUB 10000
300 REM THE OGRE'S CONTITUTION
...
535 PRINT "AS TOUGH AS "; OC; " WILDCATS.": PRINT
...
1010 YT = CO + ST + AG + WI
1015 OT = OC + OS + OA + OW
1020 LF = 20: REM  ROLL A 20 SIDED DIE
